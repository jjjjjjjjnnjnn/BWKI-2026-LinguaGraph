...
const TRANSLATIONS = {
    en: {
        ...
        'about.body': 'Mathematics subgraph: <b>556</b> of 1,140+ concepts · 517 relations (<b>233 shown</b>) · 219 groups. Built from <b>68 textbooks</b> (39 ZH · 18 EN · 11 DE) by <span class="mono">scripts/release.py</span> from <span class="mono">manifest.json</span>. Node size = degree (connections); colour = education level. Modes: Universe (free layout) · Space-Fill (pinned shells) · Compare (level clusters). LDS rows are graph-level values. All node labels follow the top-right UI language; every card lists ZH/EN/DE. Full methods in the <a href="../portal/index.html#methodology" target="_blank">Research Portal</a>.',
        'about.body_physics': 'Physics subgraph: <b>367</b> concepts · <b>386</b> relations · 4 levels, same pipeline (<span class="mono">outputs/physics_cognitivespace.json</span>). Node size = degree (connections); colour = education level. Modes: Universe (free layout) · Space-Fill (pinned shells) · Compare (level clusters). Textbook LDS values below are mathematics-only. Full methods in the <a href="../portal/index.html#methodology" target="_blank">Research Portal</a>.',
        ...
        'detail.ground_zh': 'ZH source hit · {n} places',
        'detail.ground_en': 'EN semantic hit',
        'detail.ground_none': 'Not grounded',
        'detail.ground_na': 'Grounding covers physics & chemistry only.',
        'detail.src_list': 'Source texts',
    ...
    de: {
        ...
        'about.body': 'Mathematik-Subgraph: <b>556</b> von 1.140+ Konzepten · 517 Relationen (<b>233 gezeigt</b>) · 219 Gruppen. Erbaut aus <b>68 Lehrbüchern</b> (39 ZH · 18 EN · 11 DE) mit <span class="mono">scripts/release.py</span> aus <span class="mono">manifest.json</span>. Knotengröße = Grad (Verbindungen); Farbe = Bildungsstufe. Modi: Universum (frei) · Raumfüllung (fixierte Schalen) · Vergleich (Stufencluster). LDS-Zeilen sind Graphenwerte. Alle Knotenlabels folgen der UI-Sprache oben rechts; jede Karte listet ZH/EN/DE. Volle Methodik im <a href="../portal/index.html#methodology" target="_blank">Forschungsportal</a>.',
        'about.body_physics': 'Physik-Subgraph: <b>367</b> Konzepte · <b>386</b> Relationen · 4 Stufen, gleiche Pipeline (<span class="mono">outputs/physics_cognitivespace.json</span>). Knotengröße = Grad (Verbindungen); Farbe = Bildungsstufe. Modi: Universum (frei) · Raumfüllung (fixierte Schalen) · Vergleich (Stufencluster). Lehrbuch-LDS unten ist nur Mathematik. Volle Methodik im <a href="../portal/index.html#methodology" target="_blank">Forschungsportal</a>.',
        ...
        'detail.ground_zh': 'ZH-Quellentreffer · {n} Stellen',
        'detail.ground_en': 'EN-semantischer Treffer',
        'detail.ground_none': 'Nicht verankert',
        'detail.ground_na': 'Grounding nur für Physik & Chemie.',
        'detail.src_list': 'Quelltexte',
    ...
    zh: {
        ...
        'about.close': '关闭',
        'about.title': '关于本图谱',
        'about.body': '数学子图：1,140+ 概念中的 <b>556</b> · 517 条关系（<b>展示 233</b>）· 219 分组。由 <span class="mono">scripts/release.py</span> 从 <span class="mono">manifest.json</span> 基于 <b>68 本教材</b>（中 39 · 英 18 · 德 11）构建。节点大小＝度（连接数）；颜色＝学段。模式：宇宙（自由布局）·空间填充（固定壳层）·比较（学段簇球）。LDS 行为全图级数值。所有节点名跟随右上 UI 语言；每张卡片都列出中英德三语。完整方法见<a href="../portal/index.html#methodology" target="_blank">研究门户</a>。',
        'about.body_physics': '物理子图：<b>367</b> 概念 · <b>386</b> 关系 · 4 学段，同管线（<span class="mono">outputs/physics_cognitivespace.json</span>）。节点大小＝度（连接数）；颜色＝学段。模式：宇宙（自由布局）·空间填充（固定壳层）·比较（学段簇球）。下表 LDS 为数学管线数值。完整方法见<a href="../portal/index.html#methodology" target="_blank">研究门户</a>。',
        ...
        'detail.ground_zh': 'ZH原文命中·{n}处',
        'detail.ground_en': 'EN语义命中',
        'detail.ground_none': '未grounding',
        'detail.ground_na': 'grounding覆盖仅理化',
