...
| 组别 | 人数 | 语言 | 来源 |
|------|------|------|------|
| 中国学生 | 20⁺ | 中文回答 | 德国学校的中国留学生 |
| 德国学生 | 20⁺ | 德语回答 | 同校德国同学 |
| 英语学生 | 20⁺ | 英语回答 | 国际学校/在线招募 |
| **总计** | **60⁺** | | |

> **统计功效说明** (Power Analysis):
> - **设计**: 3 组间 × 5 主题组内混合设计 (Mixed ANOVA)
> - **假设**: 中等效应量 f=0.25 (对应 η²=0.06)
> - **目标功效**: 1-β = 0.80, α = 0.05
> - **所需样本量**: 每组 18-20 人 (G*Power 计算: F-test, ANOVA: Repeated measures, between factors)
> - **推荐**: 每组 20 人 (应对数据缺失/无效回答)
> - **Pilot 阶段**: 每组 3 人 (3+3+3)，验证效应方向后扩大至 20+20+20
>
