...
**Ehrliche Grenzen**:
- **Beweisumfang**: Das Sprachsignal ist im Basismodell und in einer **51-Messungs-Replikation** (47 eindeutige Modelle, alle ZH-DE-Paare signifikant, Kulturrichtung über Zufallsniveau) nachgewiesen — allerdings mit ~88 % chinesischen Anbietern und einigen nicht-signifikanten englisch-haltigen Paaren. Eine produktive Anwendung als Audit-Instrument erfordert die Erweiterung auf westliche Modelle, weitere Konzepte/Sprachen.
