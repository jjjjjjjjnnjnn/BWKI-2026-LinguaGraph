...
| C19 | 58-model replication: ZH-DE separable in every model | LDS-C | 59 ok runs (58×n=30 + qwen-max n=26) / 53 identities / 177 pairs; ZH-DE 59/59 at p<0.004 (500 perm. resolution limit); 8 EN n.s. | **Mature** | **High** | Public headline 58/53/174 (qwen-max partial withheld); file truth 59/54/177 |
