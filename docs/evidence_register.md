...
| C21 | Seed-independent re-extraction does not reproduce social 0.939 (but is mechanism-confounded) | Method | 6 seed-fremde Arme (T2, A2-konform fails=0/92, D-S6): social F1 0.102–0.148 (6.8-lite: 76/92 valide, social 0.129/0.102-n72, EN 0.000; glm-5.2 r4-direct: 91/92 valide, social 0.140/0.138-n72, EN 0.000); beide A5-Äste verfehlt; Lücke mechanistisch erklärt (pred_n 11.7–16.8 vs. Gold 2.16 vs. qwen 2.5; EN-CJK-Leak 5–56%) → C9b bleibt Developing, Unentschieden statt Falsifikation | **Developing** | **Medium** | Prereg A1–A10; REPORT `research/mimo_spark_replication/REPORT.md` (rev4); F2 post-hoc, keine Retro-Rescoring |
...
| C23 | Gold harness v1 conflates prompt-obedience with extraction quality | Method | Prompt verlangt 10–20 Konzepte bei Gold-2.16; widersprüchliche Sprachanweisungen (原始语言 vs. 输出中文); 2048-Ceiling bindet Reasoning-Modelle (D-S1) | **Developing** | **Medium** | Designkritik, kein Datenbefund; Empfehlung Harness v2 |
