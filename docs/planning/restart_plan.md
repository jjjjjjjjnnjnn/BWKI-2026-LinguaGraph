...
## 0. 执行进度（2026-08-08 更新，含 D1 机制实验）

> 完整交接见 [session_handoff_20260808.md](../session_handoff_20260808.md)（v0.8）。
...
| **A5 可解释性** | 🔶 部分 | 主题级方向性模式（ZH 法理/DE 自主/EN 具体） |
...
| **🆕 论文整合** | ✅ 完成 | D1（§5）+ A4（§3.8）+ 讨论（§4.14）+ 结论/摘要同步 |

**核心科研结论（完整证据链）**: ① 人类 N=15 组间三层阴性（设计伪影）；② **LLM-as-Subject 组内设计证明语言信号真实存在**；③ **LMM 机制判定：语言代码层主导（M2），文化框架次级（M3）**；④ **语料侧：社会 Wikipedia ZH-DE 0.82 vs 数学 0.52——制度知识抹平语言，文化概念暴露语言**。
