...
for lang_code, output_file, heading_map, body_map in [
    ('DE', 'README_DE.md', {
        ...
        '12 Findings': '12 Erkenntnisse',
        'Extraction & Human Validation': 'Extraktion und Humanvalidierung',
        'Human LDS': 'Human LDS',
        'simulation baseline': 'Simulationsbasislinie',
        'Human Validation': 'Humanvalidierung',
        'Within-subject': 'Innerhalb der Versuchspersonen',
        'Between-subject': 'Zwischen den Gruppen',
        'rank order matches': 'Rangfolge ubereinstimmend mit',
        'exceeds simulation baseline': 'ubertrifft Simulationsbasislinie',
        'cross-level validation': 'Ebenenubergreifende Validierung',
        'Simulation Baseline': 'Simulationsbasislinie',
        'N=8 participants': 'N=8 Probanden',
        '90 responses': '90 Antworten',
    ...
    ('ZH', 'README_ZH.md', {
        ...
        'Human LDS': '人类 LDS',
        'simulation baseline': '模拟基线',
        'Human Validation': '人类验证',
        'Within-subject': '被试内',
        'Between-subject': '被试间',
        'rank order matches': '排序一致',
        'exceeds simulation baseline': '超过模拟基线',
        'cross-level validation': '跨层次验证',
        'Simulation Baseline': '模拟基线',
        'N=8 participants': 'N=8 参与者',
        '90 responses': '90 份回答',
