...
# Use importlib to bypass filename shadowing: when PYTHONPATH includes src/providers,
# `from openai import OpenAI` would try to import from THIS file instead of the real package.
