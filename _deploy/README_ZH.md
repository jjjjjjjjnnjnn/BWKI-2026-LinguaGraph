...
- **提取质量**：92 个黄金标注——社会概念 F1 **0.939**（n=72），数学 F1 0.674（n=20），加权总体 **0.881**。
...
> 总体为领域加权均值（(72×0.939+20×0.674)/92≈0.881）。标题数字 0.939 仅适用于社会概念子集。注：72 条社会标注为机器接受（`auto_accepted`）；数学德语（0.506）仅 n=7，方差大。
