...
**Ehrliche Grenzen**:
- **Beweisumfang**: Das Sprachsignal ist im Basismodell und in einer **51-Messungs-Replikation** (47 eindeutige Modelle, alle ZH-DE-Paare signifikant, Kulturrichtung über Zufallsniveau) nachgewiesen — allerdings mit ~94 % chinesischen Anbietern (zwei US-Modelle) und einigen nicht-signifikanten englisch-haltigen Paaren. Anbieter-stratifiziert (50 vollständige Messungen): CN 48/48 signifikant (Marge 0,130), US 2/2 (Marge 0,127) — richtungskonsistent, aber n=2 prinzipiell unterpowert. Die schwächeren EN-Paare sind mit der Englisch-Zentriertheit aktueller Modelle konsistent (Paper §2.5, [43]–[45]). Eine produktive Anwendung als Audit-Instrument erfordert die Erweiterung auf westliche Modelle, weitere Konzepte/Sprachen.
