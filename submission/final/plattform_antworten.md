...
**Ehrliche Grenzen**:
- **Beweisumfang**: Das Sprachsignal ist im Basismodell und in einer **51-Messungs-Replikation** (47 eindeutige Modelle, alle ZH-DE-Paare signifikant, Kulturrichtung über Zufallsniveau) nachgewiesen — allerdings mit ~94 % chinesischen Anbietern (zwei US-Modelle) und einigen nicht-signifikanten englisch-haltigen Paaren. Eine produktive Anwendung als Audit-Instrument erfordert die Erweiterung auf westliche Modelle, weitere Konzepte/Sprachen.
...
- **Heuristischer Schwellenwert (Vorschlag)**: ZH-DE-Marge ≥ 0.10 = "hohe sprachübergreifende Divergenz" (trennt hoch-divergente von niedrig-divergenten Modellen über die beobachtete Spanne +0.03 bis +0.29); als anwendbare Faustregel, keine validierte Validitätsgrenze.
